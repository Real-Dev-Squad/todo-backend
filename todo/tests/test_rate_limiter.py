...
class RateLimiterServiceTest(TestCase):
    ...
    def test_sliding_window_count_with_windows(self):
        ...
        mock_windows = [{"window_start": window_start, "request_count": 50}]
...
class RateLimiterMiddlewareTest(TestCase):
    ...
    def test_process_request_rate_limited(self):
        ...
        self.mock_service.is_rate_limited.return_value = (
            True,
            {"current_count": 150, "max_requests": 120, "window_size_minutes": 5, "requests_per_second": 120},
        )
    ...
    def test_process_request_not_rate_limited(self):
        ...
        self.mock_service.is_rate_limited.return_value = (
            False,
            {"current_count": 50, "max_requests": 120, "window_size_minutes": 5, "requests_per_second": 120},
        )
    ...
    def test_process_response_with_rate_limit_data(self):
        ...
        request = self.factory.get("/api/tasks/")
        request.rate_limit_data = {"max_requests": 120, "remaining_requests": 70, "window_size_minutes": 5}
