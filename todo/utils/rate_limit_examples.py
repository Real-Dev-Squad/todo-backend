...
def example_rule_management():
    ...
    rules = {
        "public": {"window_size_minutes": 5, "num_windows": 3, "requests_per_second": 100, "sliding_scale_factor": 0.8},
        "authenticated": {
        ...
        "admin": {"window_size_minutes": 5, "num_windows": 3, "requests_per_second": 500, "sliding_scale_factor": 1.0},
    }
