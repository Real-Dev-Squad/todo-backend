...
class TaskNotFoundExceptionTests(TestCase):
    def test_with_task_id_sets_detail_and_source(self):
        ...
        self.assertEqual(exception.detail, ValidationErrors.TASK_ID_NOT_FOUND.format("12345"))
        self.assertEqual(exception.api_error_source, {ApiErrorSource.PARAMETER: "task_id"})
